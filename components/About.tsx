    ...
    <div className="w-screen grid">
      <div className="flex p-12">
        <div className="w-full h-full z-10 md:grid md:grid-cols-2 text-neutral-50">
          <div className="flex flex-col justify-center bg-neutral-800 p-12">
            ...
            <p className="mt-4">
              I’m a software engineer who wants to know how I can be the best at
              it. I am always looking for an opportunity to drive any part of
              this world. All the projects on my GitHub were designed and
              developed by myself. I’m a quick learner who is looking for bigger
                ...
                <div key={index}>
                  ...
                  <div className="flex">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={
                        inView ? { width: entry.progress + "%" } : { width: 0 }
                      }
